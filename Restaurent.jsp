...
<body>
	<div class="header">
            <div class="logo">
                <img class="logo-img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6M4EYn2PYDp9tiEacJsZMJXIsU7vWqUi7Aw&s;" alt="logo image"/>
            </div>
             <div class="nav-items">
        		<ul>
          			<li>Home</li>
    ...
    String jdbcURL = "jdbc:mysql://localhost:3306/Foodapp";
